...
\begin{subequations} \label{eq:hybrid-weak}
	\begin{align}
		...
		\langle\bm{u},\bm{z}\rangle_{\Gamma_h} &= 0 ~~\forall\, \bm{z} \in \mathcal{L}_0, \label{eq:hybrid-weak-c}
	\end{align}
\end{subequations}
...
Recently,  \cite{puga2025stable}, the authors overcome this issue by performing a second 
