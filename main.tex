...
{\giovane Decidi colocar esta secao para definir os espacos discretos. Desconsiderar por enquanto os rascunhos}
...
\noindent where $\bm{D}^T=[\langle\bm{s}^t,\bm{v}\rangle_{\partial\mathcal{T}_h}]$. Analogous, 
